...
async function verifyPixel() {
  ...
  if ('content' in indexHtml) {
    ...
    const hasPixelInit = content.includes("fbq('init', '2175156656589537')");
    ...
    const hasNoscript = content.includes('facebook.com/tr?id=2175156656589537');
    ...
    if (bodySection && bodySection[0].includes('facebook.com/tr?id=2175156656589537')) {
