...
async function verifyPixel() {
  ...
  if ('content' in indexHtml) {
    ...
    const hasPixelInit = content.includes("fbq('init', '4349636335277595')");
    ...
    const hasNoscript = content.includes('facebook.com/tr?id=4349636335277595');
    ...
    if (bodySection && bodySection[0].includes('facebook.com/tr?id=4349636335277595')) {
