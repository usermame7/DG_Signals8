...
async function completeVerification() {
  ...
  const localChecks = {
    ...
    'fbq init with ID 2175156656589537': localContent.includes("fbq('init', '2175156656589537')"),
    'PageView tracking': localContent.includes("fbq('track', 'PageView')"),
    'Noscript fallback': localContent.includes('facebook.com/tr?id=2175156656589537&ev=PageView&noscript=1'),
    'Script in <head>': /<head>[\s\S]*fbq\('init'[\s\S]*<\/head>/.test(localContent),
    'Noscript in <body>': /<body>[\s\S]*<noscript>[\s\S]*facebook\.com\/tr\?id=2175156656589537[\s\S]*<\/noscript>/.test(localContent)
  };
  ...
  if ('content' in githubFile) {
    ...
    const githubChecks = {
      ...
      'fbq init with ID 2175156656589537': githubContent.includes("fbq('init', '2175156656589537')"),
      'PageView tracking': githubContent.includes("fbq('track', 'PageView')"),
      'Noscript fallback': githubContent.includes('facebook.com/tr?id=2175156656589537&ev=PageView&noscript=1'),
      'Script in <head>': /<head>[\s\S]*fbq\('init'[\s\S]*<\/head>/.test(githubContent),
      'Noscript in <body>': /<body>[\s\S]*<noscript>[\s\S]*facebook\.com\/tr\?id=2175156656589537[\s\S]*<\/noscript>/.test(githubContent)
    };
